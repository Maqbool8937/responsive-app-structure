...
class ReportsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: mediaQuerySize.width * 0.02.w, vertical: mediaQuerySize.height * 0.04.h),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Detonator Magazine', style: AppTextstyles.simpleTextBold()),
                        Container(
                ...
                Container(
                  ...
                  width: mediaQuerySize.width * 0.9.w,
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(10), boxShadow: [BoxShadow(blurRadius: 3, spreadRadius: 0, offset: Offset(0, 2))]),
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('4423 units', style: AppTextstyles.FullBlackBoldText())),
                      SizedBox(
